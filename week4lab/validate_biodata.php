...
if (isset($_POST['biodata_form'])) {
    ...
    {
        $msg .= "Error: Please insert your name.<br>";
        $count_error++;
    }
    ...
    {
        $msg .= "Error: Please insert your age.<br>";
        $count_error++;
    }
    ...
    {
        $msg .= "Error: Please select your gender.<br>";
        $count_error++;
    }
    ...
    {
        $msg .= "Error: Please insert your date of birth.<br>";
        $count_error++;
    }
    ...
    {
        $msg .= "Error: Please insert yout favourite color.<br>";
        $count_error++;
    }
    ...
    {
        $msg .= "Error: Please insert your social media.<br>";
        $count_error++;
    }
    ...
    {
        $msg .= "Error: Please insert your matric number.<br>";
        $count_error++;
    }

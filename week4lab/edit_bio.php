...
$record = array
(
    'name' => "muhammad adam mirza",
    'age' => 22,
    'sex' => "male",
    'address' => "PT22000, Jalan Kolej 6, Taman Desa Kolej",
    'email' => "a194333@siswa.ukm.edu.my",
    'dob' => "2002-11-18",
    'height' => 181,
    'phone' => "+6017-2763719",
    'color' => "#000000",
    'fbtwig' => "https://www.youtube.com",
    'univ' => "UKM",
    'matricnum' => "a194333"
);
...
<form method="post">
    ...
    <hr>
    <input type="hidden" name="matricnum" value=" value="<?php echo $record['matricnum']; ?>"">

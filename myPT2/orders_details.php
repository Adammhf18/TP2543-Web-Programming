...
<html>
<head>
    <title>Gaming Peripheral Shop : Order Details</title>
</head>
<body>
<center>
    ...
    <form action="orders_details.php" method="post">
        ...
        <select name="pid">
            ...
            foreach($result as $productrow) {
                ?>
                <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_type']." ".$productrow['fld_product_name']; ?></option>
                <?php
            }
            $conn = null;
            ?>

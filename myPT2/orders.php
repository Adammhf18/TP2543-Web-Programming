...
<html>
<head>
    <title>Gaming Peripheral Shop : Orders</title>
</head>
<body>
<center>
    ...
    <table border="1">
        ...
        try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $sql = "SELECT * FROM tbl_orders_a194333, tbl_staffs_a194333, tbl_customers_a194333 WHERE ";
            $sql = $sql."tbl_orders_a194333.fld_staff_num = tbl_staffs_a194333.fld_staff_num and ";
            $sql = $sql."tbl_orders_a194333.fld_customer_num = tbl_customers_a194333.fld_customer_num";

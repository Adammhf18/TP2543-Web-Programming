...
if (!isset($_SESSION['sid']) || $_SESSION['role'] != 'staff' && $_SESSION['role'] != 'admin' ) {
...
<head>
    ...
    <title>CryptoSeven : Staffs</title>
    <!-- Bootstrap -->
        ...
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <form action="staffs.php" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="email" type="text" class="form-control" id="staffemail" placeholder="Staff Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="staffpassword" class="col-sm-3 control-label">Password</label>
                    <div class="col-sm-9">
                        <input name="password" type="text" class="form-control" id="staffpassword" placeholder="Password" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_password']; ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="userlevel" class="form-control" id="userlevel" required>
                            ...
                            <option value="admin" <?php if(isset($_GET['edit'])) if($editrow['user_level']=="admin") echo "selected"; ?>>Admin</option>
                            <option value="staff" <?php if(isset($_GET['edit'])) if($editrow['user_level']=="staff") echo "selected"; ?>>Staff</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <table class="table table-striped table-bordered">
                ...
                try {
                    ...
                    $stmt = $conn->prepare("select * from tbl_staffs_a194333 LIMIT $start_from, $per_page");
                    $stmt->execute();
